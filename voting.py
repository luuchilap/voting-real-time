        ...
        while True:
            ...
            if msg is None:
                ...
                try:
                    ...
                    if cur.rowcount == 0:
                        duplicate_vote_message = "Skipping duplicate vote for voter_id {}".format(vote['voter_id'])
                        print(duplicate_vote_message)
                        conn.commit()
                        continue
                    ...
                    conn.rollback()
                    formatted_error_message = "Error inserting vote for voter_id {}: {}".format(vote['voter_id'], error)
